...
export class RouterAdd extends Component {
  ...
  handleSubmit = async event => {
    ...
    await fetch(Config.serverAddress + '/api/v1/routers/', {
      method: 'POST',
      headers: {
      ...
      <div>
        ...
        <form class={document.getElementsByClassName("is-invalid").length == 0 ? "was-validated" : ""}>
          <div class="form-group">
            ...
            <input type="number" placeholder="Wpisz ID routera" class="form-control is-invalid " id="deviceID" required onChange={(event) => {
            ...
            <input type="text" placeholder="Wpisz model routera" class="form-control is-invalid" id="model"  required onChange={(event) => {
